...
@register_site("travinh_baovinhlong")
def build_config() -> SiteConfig:
    """
    Cấu hình cho https://travinh.baovinhlong.vn.
    ...
    return SiteConfig(
        key="travinh_baovinhlong",
        base_url="https://travinh.baovinhlong.vn",
        home_path="/",
        article_name="travinh_baovinhlong",
